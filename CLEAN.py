...
This program cleans the current directory of all the files named in the .gitignore file.
This .gitignore file should be in the same directory as the CLEAN.py file.
